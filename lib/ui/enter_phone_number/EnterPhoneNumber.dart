...
class _EnterPhoneNumberState extends State<EnterPhoneNumber> {
  ...
  void onButtonNextPressed(BuildContext context, String phoneNumber) {
    Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => VerifyCodeScreenWidget(verificationId: verificationId))
  );
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: FlatButton(
                        onPressed: () => {
                          this._phoneNumber = '+855'+ this._phoneNumberController.text,
                          this._sendCodeToPhoneNumber().then((_) async {
                            this.onButtonNextPressed(context, _phoneNumber);
                          })
                        },
